...
let vn = './Menu.png'
let pp = imagen4
let img = await(await fetch('https://telegra.ph/file/9bc497cad577dc0429834.jpg')).buffer()
...
*✍︎☢︎︎ اسـم الـبوت : Henry - Bot*🤩😍
*✍︎☢︎︎ حط قبل كل امر*  (.)
*✍︎☢︎︎ اســم الـمطور Karzma*🤩😍
*✍︎☢︎︎ الـمنـصه  Heroku*
